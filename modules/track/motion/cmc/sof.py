...
from modules.track.motion.cmc.base_cmc import BaseCMC
from modules.track.utils import TRACKER_PATH
...
def main():
    sof = SOF(scale=0.25, align=True, grayscale=True, draw_optical_flow=True)
    ...
    if sof.warped_img is not None:
        ...
        cv2.imwrite(str(TRACKER_PATH / 'motion/cmc/sof_aligned.jpg'), warped)
