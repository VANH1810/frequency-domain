...
from modules.track.appearance.backbones.clip.make_model import make_model
from modules.track.appearance.backbones.hacnn import HACNN
from modules.track.appearance.backbones.lmbn.lmbn_n import LMBN_n
from modules.track.appearance.backbones.mlfn import mlfn
from modules.track.appearance.backbones.mobilenetv2 import mobilenetv2_x1_0, mobilenetv2_x1_4
from modules.track.appearance.backbones.osnet import (
    osnet_ibn_x1_0,
    osnet_x0_5,
    osnet_x0_25,
    osnet_x0_75,
...
from modules.track.appearance.backbones.osnet_ain import (
    osnet_ain_x0_5,
    osnet_ain_x0_25,
    osnet_ain_x0_75,
    osnet_ain_x1_0,
)
from modules.track.appearance.backbones.resnet import resnet50, resnet101
...
def build_model(name, num_classes, loss="softmax", pretrained=True, use_gpu=True):
    ...
    if 'clip' in name:
        ...
        from modules.track.appearance.backbones.clip.config.defaults import _C as cfg
