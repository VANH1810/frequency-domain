...
from modules.track.utils import WEIGHTS
from modules.track.utils import logger as LOGGER
from modules.track.utils.torch_utils import select_device
from modules.track.appearance import export_formats
from modules.track.appearance.backends.onnx_backend import ONNXBackend
from modules.track.appearance.backends.openvino_backend import OpenVinoBackend
from modules.track.appearance.backends.pytorch_backend import PyTorchBackend
from modules.track.appearance.backends.tensorrt_backend import TensorRTBackend
from modules.track.appearance.backends.tflite_backend import TFLiteBackend
from modules.track.appearance.backends.torchscript_backend import TorchscriptBackend
from modules.track.appearance.backends.base_backend import BaseModelBackend
...
class ReidAutoBackend():
    ...
    def model_type(self, p: Path) -> Tuple[bool, ...]:
        ...
        return tuple(types)  # Convert list to tuple